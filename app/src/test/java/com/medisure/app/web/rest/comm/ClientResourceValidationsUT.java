...
class ClientResourceValidationsUT {
    ...
    private ClientResourceValidations clientResourceValidations;

    @BeforeEach
    void init() {
        clientResourceValidations = new ClientResourceValidations(webClientConfig, oAuth);
    }

    @Test
    void getClientNullCheck() {
        when(oAuth.getToken()).thenReturn("");
        Mono<ResponseEntity<Map<String, String>>> result = clientResourceValidations.getClient();
    ...
    void getClient() {
        ...
        Mono<ResponseEntity<Map<String, String>>> response = clientResourceValidations.getClient();
