...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.medisure.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.medisure.app.security.DomainUserDetailsService", "createSpringSecurityUser");
